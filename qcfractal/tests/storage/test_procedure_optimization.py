...
def test_procedure_optimization_query(storage_socket):
    ...
    procs = storage_socket.task.optimization.get(all_ids, include=["*", "task_obj"])
    ...
    meta, procs = storage_socket.task.optimization.query(created_after=datetime.utcnow())
