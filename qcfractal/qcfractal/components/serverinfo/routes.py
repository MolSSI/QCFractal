...
@api.route("/v1/information", methods=["GET"])
@wrap_route("READ")
def get_information():
...
@api.route("/v1/access_logs/query", methods=["POST"])
@wrap_route("READ")
...
@api.route("/v1/access_logs/bulkDelete", methods=["POST"])
@wrap_route("DELETE")
...
@api.route("/v1/access_logs/summary", methods=["GET"])
@wrap_route("READ")
...
@api.route("/v1/server_stats/query", methods=["POST"])
@wrap_route("READ")
...
@api.route("/v1/server_stats/bulkDelete", methods=["POST"])
@wrap_route("DELETE")
...
@api.route("/v1/server_errors/query", methods=["POST"])
@wrap_route("READ")
...
@api.route("/v1/server_errors/bulkDelete", methods=["POST"])
@wrap_route("DELETE")
