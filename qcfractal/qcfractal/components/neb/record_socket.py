    ...
    def iterate_service(
        ...
        if service_state.iteration == 0:
            ...
            if service_state.optimized:
                ...
                chain_list = [
                    [[mol.molecular_charge, mol.molecular_multiplicity], mol.symbols.tolist(), mol.geometry]
                ...
                respaced_chain = [Molecule(**molecule_template, geometry=img[2]) for img in chain_respaced]
