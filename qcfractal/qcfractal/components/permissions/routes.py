...
@api_v1.route("/users/<string:username>", methods=["PUT"])
@wrap_route("WRITE")
...
@api_v1.route("/users/<string:username>/password", methods=["PUT"])
@wrap_route("WRITE")
...
@api_v1.route("/users/<string:username>", methods=["DELETE"])
@wrap_route("DELETE")
