...
@api.route("/v1/molecules/<int:molecule_id>", methods=["GET"])
@wrap_route("READ")
...
@api.route("/v1/molecules/bulkGet", methods=["POST"])
@wrap_route("READ")
...
@api.route("/v1/molecules/bulkCreate", methods=["POST"])
@wrap_route("WRITE")
...
@api.route("/v1/molecules/query", methods=["POST"])
@wrap_route("READ")
