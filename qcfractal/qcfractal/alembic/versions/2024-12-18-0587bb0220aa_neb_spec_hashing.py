...
def upgrade():
    ...
    op.add_column("neb_specification", sa.Column("specification_hash", sa.String(), nullable=False))
    op.add_column("neb_specification", sa.Column("protocols", postgresql.JSONB(astext_type=sa.Text()), nullable=False))
