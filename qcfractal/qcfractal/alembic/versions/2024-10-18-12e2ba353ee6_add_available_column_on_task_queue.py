...
def upgrade():
    ...
    op.execute("CREATE INDEX ix_task_queue_sort ON task_queue (priority, sort_date, id, tag) WHERE available = True;")
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_task_queue_sort", table_name="task_queue")
    op.execute("CREATE INDEX ix_task_queue_sort ON task_queue (priority, sort_date, id, tag);")
