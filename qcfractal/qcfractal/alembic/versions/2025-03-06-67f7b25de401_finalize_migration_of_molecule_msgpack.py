...
def upgrade():
    ...
    while True:
        ...
        for mol in results:
            updates = {
                "mol_id": mol.id,
                "symbols_tmp": msgpack_migrations.deserialize_msgpackext(mol.symbols),
                "geometry_tmp": msgpack_migrations.deserialize_msgpackext(mol.geometry),
                "masses_tmp": msgpack_migrations.deserialize_msgpackext(mol.masses),
                "real_tmp": msgpack_migrations.deserialize_msgpackext(mol.real),
                "atom_labels_tmp": msgpack_migrations.deserialize_msgpackext(mol.atom_labels),
                "atomic_numbers_tmp": msgpack_migrations.deserialize_msgpackext(mol.atomic_numbers),
                "mass_numbers_tmp": msgpack_migrations.deserialize_msgpackext(mol.mass_numbers),
                "fragments_tmp": msgpack_migrations.deserialize_msgpackext(mol.fragments),
