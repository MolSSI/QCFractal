...
from qcfractal.interface.models import SinglePointRecord, TaskStatusEnum
...
class ResultSocket:
    ...
    def add(self, record_list: List[SinglePointRecord]):
        """
    ...
    def update(self, record_list: List[SinglePointRecord]):
        """
