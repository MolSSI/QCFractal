...
@pytest.mark.parametrize("data, hash_index", [
    ...
    ({"program": "PSI4", "options": {"HI": [1, 2, 3], "All": [1.e-5, 2.e-3, 1.e-16]}},
     "2d93c6c81466a2c51ec2e1a4f9e53a2c6bd9e3ed"),

    ({"program": "PSI4", "options": {"HI": [1, 2, 3], "All": [1.e-5, 2.e-3, 1.e-16]}, "lowercase": False},
     "3a6a8e2fb0449ec3db81191daf5de66f9a63c088"),

    ({"program": "PSI4", "options": {"HI": [1, 2, 3], "All": [1.e-5, 2.e-3, 1.e-16]}, "exact_floats": True},
     "7860429a00fe05f4e3a829c2e5680cd5a0fa94b6"),

    ({"program": "PSI4", "options": {"HI": [1, 2, 3], "All": [1.e-5, 2.e-3, 1.e-16]}, "exact_floats": True, "lowercase": False},
     "f0c58a301466f29c43cc303260e044e94551bc0a"),

    # Check recursive
    ({"program": "PSI4", "options": {"d1": {"D2": [1.e-17, 5]}}},
     "e50f3c0a580ca846b484a21a5a28058785fb8d00"),

    ({"program": "PSI4", "options": {"d1": {"D2": [1.e-17, 5]}}, "exact_floats": True, "lowercase": False},
     "ab6ce6dade7454730d2872c95e8f84449e00b321"),

    # Check hash_index build
    ({"program": "PSI4", "options": {}, "hash_index": "waffles"},
     "waffles"),

    ({"program": "PSI4", "options": {}, "hash_index": "waffles", "build_index": True},
...
def test_option_canary_hash(data, hash_index):
    ...
    assert hash_index == opt.hash_index, opt.options


@pytest.mark.parametrize("data1, data2", [
    # Test case sensitivity
    ({"program": "Psi4", "options": {}},
     {"program": "psi4", "options": {}}),

    # Test float creation
    ({"program": "Psi4", "options": {"CAPS": 5, "other": 4.e-3}},
     {"program": "psi4", "options": {"caps": 5, "other": 0.004}}),

    ({"program": "Psi4", "options": {"other": 4.123e-5}},
     {"program": "psi4", "options": {"OTHER": 0.00004123}}),

    # Test list of floats
    ({"program": "S", "options": {"other": [1.11e-2, 2.22e-3]}},
     {"program": "s", "options": {"other": [0.0111, 0.00222]}}),

    # Test small floats
    ({"program": "S", "options": {"other": 1 + 1.e-17}},
    ...
    ({"program": "PSI4", "options": {"d1": {"D2": [0.0, 5], "d3": (3, 1.e-17)}}},
     {"program": "PSI4", "options": {"d1": {"d2": [1.e-17, 5], "d3": (3, 0)}}}),
