...
@check_access
def get_output_v1(id: Optional[int] = None, *, url_params: CommonGetURLParameters):
    return get_helper(id, url_params.id, url_params.missing_ok, storage_socket.outputstore.get)
