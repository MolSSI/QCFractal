...
class UserSocket:
    ...
    def change_password(self, username: str, password: str, *, session: Optional[Session] = None) -> None:
        """
    ...
    def reset_password(self, username: str, *, session: Optional[Session] = None) -> str:
        """
    ...
    def delete(self, username: str, *, session: Optional[Session] = None):
        """Removes a user
