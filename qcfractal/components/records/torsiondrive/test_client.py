...
from qcfractal.portal.records.torsiondrive import TorsiondriveKeywords, TorsiondriveSpecification
...
# @pytest.mark.parametrize("tag", [None, "tag99"])
# @pytest.mark.parametrize("priority", list(PriorityEnum))
# def test_torsiondrive_client_tag_priority_not_as_service(snowflake_client: PortalClient, tag: Optional[str], priority: PriorityEnum):
#    peroxide2 = load_molecule_data("peroxide2")
#    meta1, id1 = snowflake_client.add_torsiondrives(
#        [[peroxide2]],
#        "torsiondrive",
...
def test_torsiondrive_client_add_get(snowflake_client: PortalClient, spec: OptimizationInputSpecification):
