"""Adds a empty protocols column to all base_results
...
def upgrade():
    ...
    op.add_column('base_result', sa.Column('protocols', postgresql.JSONB(astext_type=sa.Text()), nullable=False), default=lambda: {})
