...
def upgrade():
    ...
    op.alter_column("base_result", "protocols", existing_type=postgresql.JSONB(astext_type=sa.Text()), nullable=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("base_result", "protocols", existing_type=postgresql.JSONB(astext_type=sa.Text()), nullable=True)
