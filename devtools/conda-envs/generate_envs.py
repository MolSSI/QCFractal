...
environs = [
    ...
    },
    {
        ...
        "dependencies":
        ["rdkit", "dask", "distributed", "dask-jobqueue >=0.5.0"],
    },
    {
        # Tools to test out parsl adapter
        "filename": "adapter_parsl.yaml",
        "dependencies":
        ["rdkit", "ipyparallel", "ipykernel", "parsl >=0.9.0"],
    },
    {
    ...
    },
    {
        ...
        "dependencies": ["psi4>1.4a2.dev700,<1.4a2", "rdkit", "geometric >=0.9.3", "torsiondrive", "dftd3",
                         "openforcefield >=0.7.1", "openforcefields >=1.2.0", "openmm >=7.4.2",
