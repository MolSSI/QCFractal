...
def test_client1():
    ...
    db.add_rxn("He 2 - 5", [("""He 0 0 5\n--\nHe 0 0 -5""", 1.0), ("He 0 0 0", -2.0)], reaction_results={"Benchmark": -1.0})
    db.add_rxn("He 4 - 5", [("""He 0 0 5\n--\nHe 0 0 -5\n--\nHe 0 4 0\n--\nHe 3 0 0""", 1.0), ("""He 0 0 0""", -4.0)], reaction_results={"Benchmark": -3.0})
    db.save()
...
def test_client_ie():
    ...
    db.add_ie_rxn("CHNO", """C 0 0 5\n--\nH 0 0 -5\n--\nN 0 4 0\n--\nO 3 0 0""", reaction_results={"Benchmark": -3.0})
    db.save()
    ...
    ret = db.compute("BP/aug-cc-pVDZ", stoich='cp', other_fields={"return_value": 1}, program="pass")
    assert ret["submit"]["success"] == True
