...
@pytest.mark.parametrize("background", [True, False])
def test_torsiondrive_dataset_model_modify_records(dataset_submit_test_client: PortalClient, background):
    ds = dataset_submit_test_client.add_dataset("torsiondrive", "Test dataset")
...
def test_torsiondrive_dataset_model_create_view(dataset_submit_test_client: PortalClient, tmp_path_factory):
    ds = dataset_submit_test_client.add_dataset("torsiondrive", "Test dataset")
