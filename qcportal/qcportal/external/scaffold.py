...
def to_json(ds, filename="scaffold.json", indent=4):
    ...
    inputs = ["dataset_type", "name", "description", "tagline", "tags", "group", "provenance", "visibility",
              "default_tag", "default_priority", "metadata", "owner_group"] # Inputs for client.add_dataset(
